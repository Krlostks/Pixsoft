                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 glass rounded-2xl text-sm font-medium text-foreground hover:bg-secondary/50 transition-all duration-300"
                    >
                  ...
                  {/* View Mode Toggle */}
                  <div className="hidden sm:flex items-center glass rounded-2xl p-1">
                    <button
